...
class LoginForm(QWidget):
    def __init__(self):
        ...
        self.label.setPixmap(QPixmap("../images/hero.png"))
        ...
        self.screen_name_layout.setObjectName("screen_name_layout")
    ...
    def retranslateUi(self, login_form):
        login_form.setWindowTitle(
            QCoreApplication.translate("login_form", "Form", None)
        )
        self.pushButton.setText(
            QCoreApplication.translate("login_form", "Sign On", None)
        )
        self.label.setText("")
        self.sn_label.setText(
            QCoreApplication.translate("login_form", "Screen Name", None)
        )
        self.pass_label.setText(
            QCoreApplication.translate("login_form", "Password", None)
        )
